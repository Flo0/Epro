...
public final class ResourceCopy {
  ...
  /**
   * Copies a set of resources into a temporal directory, optionally preserving the paths of the resources.
   *
   * @param preserve Whether the files should be placed directly in the directory or the source path should be kept
  ...
  /**
   * Copies a set of resources into a directory, preserving the paths and names of the resources.
   *
