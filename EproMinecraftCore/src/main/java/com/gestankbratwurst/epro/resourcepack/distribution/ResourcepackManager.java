package com.gestankbratwurst.epro.resourcepack.distribution;

import com.gestankbratwurst.epro.EproCore;
import com.gestankbratwurst.epro.resourcepack.assembly.AssetLibrary;
import com.gestankbratwurst.epro.resourcepack.assembly.ResourcepackAssembler;
...
public class ResourcepackManager {
  ...
  public ResourcepackManager(String host, int port) {
    EproCore plugin = EproCore.getInstance();
    this.port = port;
    this.host = host;
  ...
  public void startServer() {
    this.startServer(EproCore.getInstance());
  }
