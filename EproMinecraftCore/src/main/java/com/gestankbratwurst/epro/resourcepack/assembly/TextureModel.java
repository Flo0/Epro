...
import com.gestankbratwurst.epro.tablist.abstraction.TabLine;
import com.gestankbratwurst.epro.utils.spigot.ItemBuilder;
import com.gestankbratwurst.epro.utils.spigot.NamespaceFactory;
import com.gestankbratwurst.epro.utils.spigot.UtilItem;
...
public class TextureModel {
  ...
  public ItemStack getItem() {
    if (this.item == null) {
      this.item = new ItemBuilder(this.baseMaterial)
              ...
              .name(modelName)
              .addPersistentData("model-id", PersistentDataType.STRING, modelName)
              .build();
    }
  ...
  public ItemStack getHead() {
    ...
    container.set(NamespaceFactory.provide("Model"), PersistentDataType.STRING, modelName);
